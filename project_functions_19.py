...
def ms_elastic_net(df, all_earn = None, dep = None, cols = None, col_list = None, alpha = 1.0, l1_ratio = 0.5, max_iter = 1000):
    ...
    e_net = ElasticNet(alpha= alpha, l1_ratio= l1_ratio, max_iter= max_iter)
